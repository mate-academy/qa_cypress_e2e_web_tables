...
describe('Web Tables page', () => {
  ...
  it('should have pagination', () => {
    ...
    cy.get('button').should('contain.text', 'Previous');
  });

  it('should have roows count selection', () => {
  ...
  it('should provide an ability to find a worker, edit, validate data',
    () => {
  ...
  it('should check the search by all column values.', () => {
    ...
    cy.get('.rt-tbody').should('contain', 'kierra@example.com');
    cy.get('#searchBox').clear();
