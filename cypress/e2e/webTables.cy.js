...
describe("Web Tables page", () => {
  ...
  it("should check if pagination is present on the website", () => {
  ...
  it("should provide the ability to use pagination", () => {
    cy.get(".-pageInfo").should("exist");
    cy.get(".-pageJump").should("exist");
    cy.get(".-totalPages").should("exist");
    cy.get(".-previous").should("exist");
  ...
  it("should check if the table exists", () => {
  ...
  it("ability to find a worker in the search field, edit it and validate data.", () => {
    ...
    cy.task("generateUser").then((generateUser) => {
      ...
      cy.get("#department").type(worker.department);
      cy.get("#submit").click();
      cy.get(".rt-tr-group").should("contain", worker.department);
    });
  });
