describe("Web Tables page", () => {
  ...
  it("should have the pagination", () => {
    ...
    cy.get(".-pagination").should("contain.text", "Next").click();
    cy.get(".-pagination").should("contain.text", "Previous").click();
    cy.get(".-pagination").should("contain.text", "Page");
    cy.get(".-pagination .-pageJump input").should(
      "have.attr",
      "type",
      "number"
    );
  ...
  it("should add a new worker and validate data in worker row after creating", () => {
    cy.get("#addNewRecordButton").click();
    cy.get("#firstName").type(user.firstName);
    cy.get("#lastName").type(user.lastName);
    cy.get("#userEmail").type(user.email);
  ...
  it.only("should delete workers by Delete buttons", () => {
