...
describe('Web Tables page', () => {
  ...
  it('Check the choice of the number of lines', () => {
    cy.get('select')
      .should('exist')
      .should('be.visible');
  });

  it('check whether can add a new user', () => {
  ...
  it('check the deletion of an employee', () => {
  ...
  it('check for find a worker in the search field and edit it.', () => {
    cy.get('#searchBox')
      .type('Alden{enter}');
